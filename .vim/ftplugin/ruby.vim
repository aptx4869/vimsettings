...
if !exists("g:no_plugin_maps") && !exists("g:no_ruby_maps")
  ...
  if maparg("\<C-]>",'n') == ''
    ...
    nnoremap <silent> <buffer> <M-W>]      :<C-U>exe v:count1."stag <C-R>=RubyCursorIdentifier()<CR>"<CR>
    nnoremap <silent> <buffer> <M-W><C-]>  :<C-U>exe v:count1."stag <C-R>=RubyCursorIdentifier()<CR>"<CR>
    nnoremap <silent> <buffer> <M-W>g<C-]> :<C-U>exe        "stjump <C-R>=RubyCursorIdentifier()<CR>"<CR>
    nnoremap <silent> <buffer> <M-W>g]     :<C-U>exe      "stselect <C-R>=RubyCursorIdentifier()<CR>"<CR>
    nnoremap <silent> <buffer> <M-W>}      :<C-U>exe          "ptag <C-R>=RubyCursorIdentifier()<CR>"<CR>
    nnoremap <silent> <buffer> <M-W>g}     :<C-U>exe        "ptjump <C-R>=RubyCursorIdentifier()<CR>"<CR>
    let b:undo_ftplugin = b:undo_ftplugin
          \."| sil! exe 'nunmap <buffer> <C-]>'| sil! exe 'nunmap <buffer> g<C-]>'| sil! exe 'nunmap <buffer> g]'"
          \."| sil! exe 'nunmap <buffer> <M-W>]'| sil! exe 'nunmap <buffer> <M-W><C-]>'"
          \."| sil! exe 'nunmap <buffer> <M-W>g<C-]>'| sil! exe 'nunmap <buffer> <M-W>g]'"
          \."| sil! exe 'nunmap <buffer> <M-W>}'| sil! exe 'nunmap <buffer> <M-W>g}'"
  endif
endif
